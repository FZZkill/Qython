...
def Token_Append_KeyWords(Token: list):
    ...
    while len(Token) != 0:
        ...
        if x["type"] == parser[-1]["type"]:
            Error = True
            print(
                "Error: Too many types (" + x["type"] + ")! in line: ",
                x["line"],
                " ,in column: ",
                x["column"],
            )
...
def Token_Append_Function(Token: list):
    ...
    while len(Token) != 0:
        ...
        if b not in types_fun:
            Error = True
            print(
                "Error: Error of function return type! in line: ",
                x["line"],
                " ,in column: ",
                x["column"],
            )
        ...
        if b != "IDENTIFIER":
            Error = True
            print(
                "Error: Error of function name! in line: ",
                x["line"],
                " ,in column: ",
                x["column"],
            )
        ...
        if b == "(":
            while b == ")":
                ...
                if b == "ENDER":
                    Error = True
                    print(
                        "Error: Error of function )! in line: ",
                        x["line"],
                        " ,in column: ",
                        x["column"],
                    )
    ...
    while len(Token) != 0:
        ...
        if b in Obstract:
            ...
            if sm > 0 or zm > 0 or bm > 0:
                Error = True
                print(
                    "Error: Paired parentheses could not be found ! in line: ",
                    x["line"],
                    " ,in column: ",
                    x["column"],
                )
